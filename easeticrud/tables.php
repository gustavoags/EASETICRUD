            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Tabela de Clientes</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <h2>
                                <a href="register.php" class="btn btn-primary float-end">Adicionar usuário</a>
                                </h2>
                            </div>
                        </div>
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <a href="cliente-view.php?id=<?=$cliente['id']?>" class="btn btn-secondary btn-sm">Visualizar</a>
                                            <a href="cliente-edit.php?id=<?=$cliente['id']?>" class="btn btn-success btn-sm">Editar</a>
                                            <form action="acoes.php" method="POST" class="d-inline">
                                                <button onclick="return confirm('Tem certeza que deseja excluir?')" type="submit" name="delete_cliente" value="<?=$cliente['id']?>" class="btn btn-danger btn-sm">Excluir</button>
                                            </form>
                                            </td>
                                          </tr>
                                          <?php 
