                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted">Digite o seu endereço de E-mail e enviaremos um link para redefinir sua senha.</div>
                                        <form>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="login.html">Retornar ao Login</a>
                                                <a class="btn btn-primary" href="login.html">Recuperar senha</a>
                                            </div>
                                        </form>
                                    </div>
