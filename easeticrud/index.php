                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="tables.php">Consultar</a>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Cadastrados</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <?php 
                                        $sql_code = "SELECT COUNT(id) AS total_ids FROM novos";
                                        $query = mysqli_query($conexao, $sql_code);
                                        $resultado = mysqli_fetch_assoc($query);
                                        echo "São " . $resultado['total_ids'] . " Cadastrados";
                                        ?>
                                    </div>
                                </div>
                            </div>                         
